                ...
                <Slider {...settings}>
                    {
                        data?.slice(0, 7)?.map((item, index) => {
                            return <div key={index} className="bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#9595ec] -z-10">
                                <div className="flex gap-10 justify-center h-[600px] items-center px-4">
                                    <div className="space-y-6">
                                        ...
                                        <div className="md:w-[500px] line-clamp-3 text-gray-400 pr-7">{item.description}</div>
                                    ...
                                    <div className="">
                                        <img src={item.image} alt={item.title} className='rounded-full w-[500px] h-[500px]
                                        hover:scale-105 transition-all shadow-2xl shadow-red-400'/>
                                    </div>
                                </div>
                            </div>
                        })
