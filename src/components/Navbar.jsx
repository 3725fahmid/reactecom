            ...
            <div className="max-w-6xl mx-auto flex justify-between items-center">
                ...
                <div className="flex gap-7 items-center">
                    ...
                    <div className="flex gap-1 cursor-pointer text-gray-700 items-center">
                        ...
                        <span>{location ? <div className='-space-x-1'>
                            <p>{location.county}</p>
                            <p>{location.state}</p>
                    ...
                    </div>
                    {
                        openDropdown ? <div className='w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-60 border-2 p-5 border-gray-100 rounded-md'>
                            <h1 className='font-semibold mb-4 text-xl flex justify-between'>Change Location <span><CgClose onClick={toggleDropDown} className='cursor-pointer' /></span></h1>
                            <button onClick={getLocation} className='bg-red-500 text-white px-5 py-1 rounded-md cursor-pointer hover:bg-red-400'>Detect my location</button>
                        </div> : null
                    }
                </div>
                {/* menu section  */}
